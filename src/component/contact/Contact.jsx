    ...
    <div className='contact' id='contact'>
      <div className='container'>
        <div className='row'>
          ...
          <div
            data-aos='fade-right'
            className='col-6 contact1 col-md-12 col-xs-12'
          >
            <ul>
              <li>Contact</li>
              ...
              <li>
                ...
                <a target='_blank' href='tel:+994775673290'>
                  +994 77-567-32-90
                </a>
              </li>
              <li>
                <i className='fa-solid fa-envelope'></i>
                <a target='_blank' href='mailto:vusal.durmushov06@gmail.com'>
                  vusal.durmushov06@gmail.com
                </a>
              </li>
              <li>
                <i className='fa-brands fa-github'></i>
                <a target='_blank' href='https://github.com/vusaldurmushov'>
                  vusaldurmushov
                </a>
              </li>
              <li>
                <i className='fa-brands fa-instagram'></i>
                <a target='_blank' href='https://www.instagram.com/vusal_99__/'>
                  vusal_99__
                </a>
              </li>
              <li>
                <i className='fa-solid fa-location-dot'></i>Azerbaijan Baku
              </li>
            </ul>
          </div>
          ...
          <div
            ref={skill}
            data-aos={width > 1592 ? "fade-left" : "zoom-in"}
            className='col-6 contact2 col-md-12 col-xs-12'
          >
